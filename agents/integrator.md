...
The process/findings split applies to `agents/` itself: it holds process, `docs/` holds findings. A
result that lives only in `box-results.md` has not been recorded.
