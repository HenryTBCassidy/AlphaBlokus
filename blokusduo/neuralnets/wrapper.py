...
"""
Neural Network wrapper for the BlokusDuo game.
...
class NNetWrapper(INeuralNetWrapper):
    ...
    def __init__(self, args: RunConfig) -> None:
        """
        Initialise the wrapper with configuration.
        ...
        self.nnet = NNet(args.net_config)
        self.board_x, self.board_y = self.nnet.board_x, self.nnet.board_y
