...
``core/self_play.py:73`` / ``core/mcts.py:253-264``), steps the env, and
...
if TYPE_CHECKING:
    ...
    from games.blokusduo.jaxenv.kernels import GameState, JaxKernels
    from games.blokusduo.jaxenv.search import SearchResult
