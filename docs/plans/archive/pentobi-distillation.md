...
> [`pentobi-corpus-v2.md`](../../../.claude/worktrees/worktree-checkbox-meaning-2134d9/docs/plans/pentobi-corpus-v2.md) after this plan's corpus failed its own gate;
...
> targets — so the generator is being replaced by [`pentobi-corpus-v2.md`](../../../.claude/worktrees/worktree-checkbox-meaning-2134d9/docs/plans/pentobi-corpus-v2.md),
