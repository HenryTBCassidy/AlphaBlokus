...
Companion to [`pentobi-corpus-v2.md`](../future/pentobi-corpus-v2.md) (whose V3 row executes this plan's
...
Executed as row V3 of [`pentobi-corpus-v2.md`](../future/pentobi-corpus-v2.md).
