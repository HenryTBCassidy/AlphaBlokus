...
**Note:** The IDs above assume contiguous 0-indexed assignment. The current codebase uses 1-indexed IDs with a known off-by-one gap between pieces (see [Bug Fixes §4](02-BUG-FIXES.md)). After the fix, the mapping will be exactly as shown above.
