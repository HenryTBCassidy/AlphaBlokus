...
Provides reusable functions for visualising board positions in both
terminal output (ASCII) and HTML reports (coloured table grids).

Usage:
    from reporting.board import dump_board, render_board_html, build_game_replay_html
"""
